...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new qiuxiang.android_window.AndroidWindowPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin android_window, qiuxiang.android_window.AndroidWindowPlugin", e);
    }
    try {
