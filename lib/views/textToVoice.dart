...
class TextToVoice extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => TextToVoiceState();
}

class TextToVoiceState extends State<TextToVoice>
  ...
  void initState() {
    ...
    _ContentEditController.text = '中国传统文化讲究节日团圆，到了春节，就更期待一家人聚在一起热热闹闹的吃饭啦。';
  }
                                  ...
                                  child: GridView.count(
                                    ...
                                    children: [
                                      ...
                                      ItemVoice(
                                          ...
                                          subtitle: '标准男声',
                                          url:
                                              'https://cdn.maxbox.com.cn/upload/dddcda44b3154e70912b769351e7f917.mp3',
                                          groupValue: groupValue,
                                          onChange: (value) => onChange(value)),
                                      ItemVoice(
                                          value: 3,
